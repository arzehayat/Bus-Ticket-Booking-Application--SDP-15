...
export default function SeatSelection() {
    ...
    const handlePassengerNumber = (e, seatNo) => {
        e.preventDefault()
        let value = e.target.value
        // console.log(value)
        if (!value) {
            return (setNumber("name is required"))
        } else {
        ...
        return seatArray.map((seat, idx) => {
            return (
                <form key={idx} className="form seatfrm">
                    ...
                    <br></br>
                    <input className="form-control seatInp" onBlur={e => handlePassengerNumber(e, seat)} type="number" name="passenger-number" placeholder="Enter Mobile Number" />
